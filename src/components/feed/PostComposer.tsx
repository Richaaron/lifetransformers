  ...
  return (
    <div
      className={cn(
        ...
        isNative ? "rounded-2xl border border-white/5 bg-surface-900/70" : "rounded-2xl"
      )}
      style={
        !isNative
          ? {
    ...
    >
      ...
      <div className={cn("p-5", isNative && "p-4")}>
        <div className={cn("flex gap-3.5", isNative && "gap-3")}>
          <Avatar className={cn(
            "mt-0.5 shrink-0 border-2 border-brand-500/25",
            isNative ? "w-10 h-10" : "w-11 h-11",
            !isNative && "shadow-[0_0_12px_rgba(234,179,8,0.15)]"
          )}>
          ...
          <div className="flex-1 min-w-0 space-y-3">
            ...
            <div className="relative min-h-[52px]">
              ...
              <div
                aria-hidden="true"
                className={cn(
                  "absolute inset-0 pt-2.5 pb-1 px-0 text-[15px] leading-relaxed pointer-events-none whitespace-pre-wrap break-words",
                  isNative && "text-base"
                )}
            ...
            <div className="flex items-center justify-between pt-3 border-t border-white/[0.05]">
              <div className="flex items-center gap-0.5">
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className={cn(
                    "flex items-center gap-1.5 px-3 py-2 rounded-xl text-surface-400 hover:text-brand-400 hover:bg-brand-500/10 text-sm font-medium transition-all duration-200 press-effect disabled:opacity-40",
                    isNative && "px-2 py-1.5"
                  )}
                >
                  <ImageIcon className="w-4 h-4" />
                  {!isNative && <span className="hidden sm:inline">Photo</span>}
                </button>
                ...
                >
                  ...
                  {!isNative && <span className="hidden sm:inline">Video</span>}
                </button>
                ...
                <button
                  ...
                  className={cn(
                    "flex items-center gap-1.5 px-3 py-2 rounded-xl text-surface-400 hover:text-purple-400 hover:bg-purple-500/10 text-sm font-medium transition-all duration-200 press-effect disabled:opacity-40",
                    isNative && "px-2 py-1.5"
                  )}
                >
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className={cn(
                    "flex items-center gap-2 px-6 py-2.5 rounded-full text-surface-950 font-bold text-sm transition-all duration-200 press-effect disabled:opacity-40 disabled:cursor-not-allowed",
                    isNative
                      ? "bg-brand-500 hover:bg-brand-400"
                      : "bg-gradient-to-r from-brand-500 to-amber-500 shadow-[0_4px_16px_rgba(234,179,8,0.3)] hover:shadow-[0_4px_24px_rgba(234,179,8,0.5)] hover:from-brand-400 hover:to-amber-400"
                  )}
                >
                  {isSubmitting ? (
            ...
            {isFocused && !mentionSuggestions.length && !isNative && (
